    ...
    return (
        <main className="w-2/3 h-full flex flex-col justify-between">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-zinc-400">Add-ons help enhance your gaming experience.</p>
            </div>
            {/* ADD-ONS */}
            <div className="w-full flex flex-col gap-4 mb-5">
                {addOns.map((a, index) => (
                    <div
                        ...
                        className={`w-full border flex justify-between items-center py-3 px-5 rounded-lg hover:border-focus cursor-pointer ${a.isChecked ? 'border-focus' : ''}`}
