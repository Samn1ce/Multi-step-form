...
function YourInfo() {
  ...
  return (
    <main className="w-11/12 md:w-2/3 h-full grid">
      <div className="flex flex-col gap-2 mb-5">
        <h1 className="text-xl md:text-3xl font-bold">Personal Info</h1>
      ...
      <form className="flex flex-col gap-5">
        <div>
          ...
          <input
            ...
            className={`h-10 w-full border px-4 rounded-lg outline-none ${
              isNameFocused === true ? "bg-focus border-focus" : ""
            }`}
            type="text"
            id="name"
            name="name"
        ...
        <div>
          ...
          <input
            ...
            className={`h-10 w-full border px-4 rounded-lg outline-none ${
              isEmailFocused === true ? "bg-focus border-focus" : ""
            }`}
            type="email"
            id="email"
            name="email"
        ...
        <div>
          ...
          <input
            ...
            className={`h-10 w-full border px-4 rounded-lg outline-none ${
              isNumFocused === true ? "bg-focus border-focus" : ""
            }`}
            type="tel"
            id="phoneNumber"
            name="phoneNumber"
